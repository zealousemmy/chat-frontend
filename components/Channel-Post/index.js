      ...
      <div className={"body"}>
        ...
        <div className={"landingpageflexcenter channelpostcenter"}>
          <ChannelPostHeroSection
            ...
            description={
              sharedState?.channelInfo?.data?.description || "Poticial conversations and gists that will spark your interest"
            }
            postCount={sharedState?.channelInfo?.data?.post_count || 0}
            membersCount={sharedState?.channelInfo?.data?.user_channel_count || 0}
          />
